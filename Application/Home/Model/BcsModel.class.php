...
Class BcsModel {
	...
	$ak = 'v4T5UD1UKe1rCjZpiTKESXes';
	$sk = 'oz2sA2kd2CcMoHAODiGVq6EwZLiom7iy';
	require_once(CORE_PATH.'Upload/Driver/Bcs/bcs.class.php');
	...
	* */
	...
	function copy_object($bucket,$object,$toBucket,$toObject) {
	...
	function delete_object($bucket=null,$object=null) {
		$response = $this->baidu_bcs->delete_object ( $bucket, $object );
		return $response->isOK();
	}
