...
$con= new mysqli("localhost","zhongeco_sxm","sxm206350482");
// Create database
if ($con->query("drop database if exists `zhongeco_3dshare`")){
	echo "database delete";
}else {
	echo "delete error";
}
if ($con->query("CREATE DATABASE if not exists `zhongeco_3dshare` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci"))
  {
...
// Create table in zhongeco_3dshare database
$con->select_db("zhongeco_3dshare");
$sqls = "
